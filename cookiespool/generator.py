...
from login.qzone.qzonecookies import QZoneCookies
from login.weibo.weibocookies import WeiboCookies
...
class CookiesGenerator(object):
    ...
    def init_browser(self):
        ...
        if BROWSER_TYPE == 'PhantomJS':
            ...
            #                                 executable_path=r'D:\Python36\Scripts\chromedriver.exe')
...
class QZoneCookiesGenerator(CookiesGenerator):
    ...
    def new_cookies(self, username, password):
        ...
        :return: 用户名和Cookies
        """
        return QZoneCookies(username, password, self.browser).main()
...
if __name__ == '__main__':
    ...
    qqgenerator = QZoneCookiesGenerator()
    qqgenerator.run()
